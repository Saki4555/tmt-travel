...
//           <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold font-jost mb-4">Explore Exclusive Travel Deals</h1>
//           <p className="text-base sm:text-lg mb-6 font-jost">Discover your next adventure with our curated offers</p>
//           {/* <a
//             href="#deals"
//             className="inline-block py-2 px-6 bg-gradient-to-r from-teal-500 to-teal-700 text-white font-medium rounded-lg hover:scale-105 transition duration-300 text-sm sm:text-base"
//           >
//             Browse Deals
//           </a> */}
//         </div>
...
//             <div
//               key={item._id}
//               className="bg-white shadow-lg group rounded-lg overflow-hidden transform transition-all"
//             >
//               {/* Top Deal Badge */}
//               {item.topDeal && (
...
import DataLoading from '../components/shared/DataLoading';
import { allTravelDealsHeroImg } from '../assets';
import { MdOutlineErrorOutline } from 'react-icons/md'; // Import the icon for empty state
...
const AllTravelDeals = () => {
  ...
  if (deals.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] bg-teal-50/70">
        <MdOutlineErrorOutline className="text-5xl text-teal-600 mb-4" />
        <h2 className="text-2xl text-gray-700 font-semibold mb-2">No Travel Deals Available</h2>
        <p className="text-center text-lg text-gray-500 max-w-xs">
          Unfortunately, there are no current deals. Please check back later or explore other sections of the site.
        </p>
      </div>
    );
  }
