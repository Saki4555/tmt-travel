      ...
      {isLoading ? (
        ...
        >
          {images.length > 0 ? (
              ...
              <SwiperSlide key={image._id}>
                ...
                >
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 text-center md:gap-6 text-white px-6">
                    <h1 className="text-2xl tracking-wide sm:text-3xl md:text-5xl font-extrabold drop-shadow-lg">
                    ...
                    <p className="text-sm tracking-wide md:text-xl max-w-2xl drop-shadow-md">
                      ...
                      <button onClick={()=> navigate('/all-travel-deals')} className="px-6 md:px-8 text-xs sm:text-sm md:text-xl bg-tmt-prim py-1 md:py-3 cursor-pointer font-semibold text-white border border-tmt-prim rounded-4xl transition-colors duration-500 hover:bg-transparent hover:text-tmt-prim">
                        Explore Now
                      </button>
            ...
            // Fallback Slide if No Images Available
            <SwiperSlide>
              <div
                className="relative w-full min-h-[calc(100vh-112px)] bg-cover bg-center rounded-lg shadow-lg"
                style={{
              ...
              >
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center gap-6 text-white px-6 bg-black/5">
                  ...
                  <button onClick={()=> navigate('/all-travel-deals')} className="px-6 md:px-8 text-xs sm:text-sm md:text-lg bg-tmt-prim py-1 md:py-3 cursor-pointer font-semibold text-white border border-tmt-prim rounded-4xl transition-colors duration-500 hover:bg-transparent hover:text-tmt-prim">
                        Explore Now
                      </button>
                </div>
              </div>
