...
const ChooseUs = () => {
    ...
    return (
      ...
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-4 ">Why Choose Us?</h2>
        <p className="text-gray-600 mb-8 text-lg sm:text-xl">Experience the best travel services with unmatched reliability.</p>
