...
const DealsAndOffers = () => {
  ...
  <div className="bg-teal-50/70 py-16 font-lato">
      ...
      <h2
        className="text-3xl text-gray-600 font-bold text-center mb-3"
      >
        <FaPlaneDeparture className="inline-block mr-2" /> Exclusive Travel
        Deals & Offers
      </h2>
      <p className="text-center text-gray-600 mb-8">
        Unlock incredible discounts on top destinations and elevate your travel
        experience!
      </p>

      {isLoading ? (
        <p
          className="text-center text-lg flex justify-center items-center gap-2"
          style={{ color: "var(--color-tmt-prim)" }}
        >
          <FaPlaneDeparture className="animate-bounce" />
        ...
        <div className="flex justify-center">
          {topDeals.length > 0 ? (
            ...
            <p
              ...
              style={{ color: "var(--color-tmt-prim)" }}
            >
              <FaRegSadCry className="text-2xl" /> Currently, there are no top
              deals available. Stay tuned for upcoming offers!
            </p>
          )}
        </div>
      )}
